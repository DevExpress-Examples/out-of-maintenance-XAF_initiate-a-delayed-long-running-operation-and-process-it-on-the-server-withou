	...
	Friend Class Program
		...
		Shared Sub Main(ByVal args() As String)
			Try
				...
				AddHandler timer.Elapsed, Function(sender, e) AnonymousMethod1(sender, e, serverApplication)
				timer.Enabled = True
		...
		Private Shared Function AnonymousMethod1(ByVal sender As Object, ByVal e As ElapsedEventArgs, ByVal serverApplication As ServerApplication) As Boolean
