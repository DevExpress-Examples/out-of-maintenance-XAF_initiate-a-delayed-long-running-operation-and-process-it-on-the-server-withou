...
Namespace LongRunningOperations.Win
	Partial Public Class LongRunningOperationsWindowsFormsApplication
		...
		End Sub
		Private Sub LongRunningOperationsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
...
#End If
		End Sub
		Private Sub LongRunningOperationsWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
